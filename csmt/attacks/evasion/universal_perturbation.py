...
from csmt.utils import projection, get_labels_np_array, check_and_transform_label_format

if TYPE_CHECKING:
    from csmt.utils import CLASSIFIER_TYPE
...
class UniversalPerturbation(EvasionAttack):
    ...
    attacks_dict = {
        "carlini": "csmt.attacks.evasion.carlini.CarliniL2Method",
        "carlini_inf": "csmt.attacks.evasion.carlini.CarliniLInfMethod",
        "deepfool": "csmt.attacks.evasion.deepfool.DeepFool",
        "ead": "csmt.attacks.evasion.elastic_net.ElasticNet",
        "fgsm": "csmt.attacks.evasion.fast_gradient.FastGradientMethod",
        "bim": "csmt.attacks.evasion.iterative_method.BasicIterativeMethod",
        "pgd": "csmt.attacks.evasion.projected_gradient_descent.projected_gradient_descent.ProjectedGradientDescent",
        "newtonfool": "csmt.attacks.evasion.newtonfool.NewtonFool",
        "jsma": "csmt.attacks.evasion.saliency_map.SaliencyMapMethod",
        "vat": "csmt.attacks.evasion.virtual_adversarial.VirtualAdversarialMethod",
        "simba": "csmt.attacks.evasion.simba.SimBA",
    }
        ...
        while fooling_rate < 1.0 - self.delta and nb_iter < self.max_iter:
            ...
            for j, ex in enumerate(x[rnd_idx]):
                ...
                if current_label == original_label:
                    ...
                    adv_xi,_ = attacker.generate(x_i + noise, y=y[rnd_idx][[j]])
