...
def gen_classification_symbolic(m=None,n_samples=100,n_features=2,flip_y=0.0,distribution='uniform'):
    """
    ...
    for i in range(n_features):
        if distribution=='normal':
            ...
            lst_features.append(np.random.uniform(size=n_samples))
        else:
            print('no this distribution')
