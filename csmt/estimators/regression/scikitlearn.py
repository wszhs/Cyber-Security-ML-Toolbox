...
from csmt.estimators.regression.regressor import RegressorMixin
...
if TYPE_CHECKING:
    ...
    from csmt.utils import CLIP_VALUES_TYPE, PREPROCESSING_TYPE
    # from csmt.defences.preprocessor import Preprocessor
    # from csmt.defences.postprocessor import Postprocessor
    # from csmt.metrics.verification_decisions_trees import LeafNode
...
class ScikitlearnRegressor(RegressorMixin, ScikitlearnEstimator):  # lgtm [py/missing-call-to-init]
    ...
    def reset(self) -> None:
        ...
        """
        # No need to do anything since scikitlearn models stcsmt from scratch each time fit() is called
        pass
