...
from csmt.feature_extractor.cicflowmeter.features.context.packet_flow_key import get_packet_flow_key
from csmt.feature_extractor.cicflowmeter.flow import Flow
...
class FlowSession(DefaultSession):
    ...
    def __init__(self,output_mode, output_file, url_model):
        ...
        super(FlowSession, self).__init__(output_mode, output_file, url_model)
