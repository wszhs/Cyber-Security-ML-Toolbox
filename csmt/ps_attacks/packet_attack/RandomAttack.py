...
def add_pkt(X,grp_size,last_end_time,groupList,max_time_extend,max_cft_pkt,max_crafted_pkt_prob):
...
def pertur_time(X,grp_size,last_end_time,groupList,max_time_extend,min_time_extend):
...
# 生成对抗流
def random_attack(grp_size,last_end_time,pktList):
    max_time_extend=6
    min_time_extend=3
    max_cft_pkt=2
    ...
    inter_arr = pertur_time(inter_arr,grp_size,last_end_time,pktList,max_time_extend,min_time_extend)
    inter_arr = add_pkt(inter_arr,grp_size,last_end_time,pktList,max_time_extend,max_cft_pkt,max_crafted_pkt_prob)
    return inter_arr