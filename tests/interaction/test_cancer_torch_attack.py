...
LastEditTime: 2021-07-03 11:39:30
...
class Net(nn.Module):
    def __init__(self):
        ...
        self.fc_1 = nn.Linear(in_features= 4* 4 * 5, out_features=20)
        self.fc_2 = nn.Linear(in_features=20, out_features=2)
...
class MLP(nn.Module):
    def __init__(self):
        ...
        self.fc_2=nn.Linear(in_features=20,out_features=10)
...
X_train=X_train.reshape(-1,1,5,6)
X_test=X_test.reshape(-1,1,5,6)
model = Net()
model2 = Net()
