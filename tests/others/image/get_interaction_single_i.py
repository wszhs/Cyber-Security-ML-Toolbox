...
LastEditTime: 2021-07-05 09:00:12
...
def get_average_pairwise_interaction_i(model,x,y,delta,con_i):
    only_add_one_perturbation, leave_one_out_perturbation = sample_for_interaction(delta,sample_grid_num=30,grid_scale=14,img_size=28,times=20,con_i=con_i)
