...
from csmt.defences.trainer.adversarial_trainer import AdversarialTrainer,TransferAdversarialTrainer
...
if __name__=='__main__':
    ...
    # 针对迁移集成的对抗训练
    adv_train_models=TransferAdversarialTrainer(datasets_name,adv_orig_models,adv_orig_models_name,trained_models,orig_models_name,evasion_algorithm,X_train,y_train,X_val,y_val)
